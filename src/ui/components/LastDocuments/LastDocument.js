...
const styles = StyleSheet.create({ 
    ...
    itemContainer: { 
        ...
        paddingTop: 18, 
        maxHeight: 22, 
        borderBottom: '0.63rem solid #DFE0EB', 
        ':last-child': { 
            borderBottom: 'none' 
        } 
    }, 
...
class LastDocument extends React.Component { 
    ...
    render() { 
        const { title, subtitle, subtitleTwo, items, containerStyles } = this.props; 
        return ( 
